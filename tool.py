...
table.add_row("এ〔 𝗆𝗒 𝗎𝗌𝖾𝗋 : @xx_YaBh 〕",style='green')
console = Console()
console.print(table)
L7n = Console()
tok = ('6802039492:AAFP9j8wMu2ZqQa5xsj2gc8aGLx654jFyj8')
print('\n')
iD = ('6376489778')
print('  '*15)
with L7n.status(F+'wait YaBh !  ',spinner_style='point'):
        time.sleep(2.5);requests.post(f"https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&video=https://t.me/x_YaBh/6&caption=")
print('             '*10)
def L7Ngmail(email):	
